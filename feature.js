...
(function () { 
features["HTML.Microdata.Element.itemScope"] = !!(document.documentElement.itemScope);
}());

(function () { 
features["HTML.Microdata.Element.itemValue"] = !!(document.documentElement.itemValue);
}());

(function () { 
features["HTML.Microdata.Element.itemRef"] = !!(document.documentElement.itemRef);
}());

(function () { 
features["HTML.Microdata.Element.itemId"] = !!(document.documentElement.itemId);
}());

(function () { 
features["HTML.Microdata.Element.properties"] = !!(document.documentElement.properties);
}());

(function () { 
features["HTML.Microdata.Element.itemProp"] = !!(document.documentElement.itemProp);
}());
